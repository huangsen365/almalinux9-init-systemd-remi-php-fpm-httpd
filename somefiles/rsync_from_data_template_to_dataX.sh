# curl -fsSL https://raw-githubusercontent-com.wansio.com/huangsen365/almalinux9-init-systemd-remi-php-fpm-httpd/refs/heads/main/somefiles/rsync_from_data_template_to_dataX.sh -o /root/rsync_from_data_template_to_dataX.sh
